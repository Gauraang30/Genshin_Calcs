def stats (wep_atk,atk_percent,flat_atk,hp_percent,flat_hp,cdmg,hydro_dmg):
    ...
    hp_dmg=0.0103*hp
    n1=((0.9717*atk)+hp_dmg*2)*dmg+((0.2*atk)*cdmg_1/2)
    n1_1=((0.9717*atk)+hp_dmg*4)*dmg+((0.2*atk)*cdmg_1/2)
    n1_dmg=n1+(n1_1*5)
    n2=(1.0823*atk+hp_dmg*3)*dmg+((0.2*atk)*cdmg_1/2)
    n2_1=(1.0823*atk+hp_dmg*4)*dmg+((0.2*atk)*cdmg_1/2)
    n2_dmg=n2+(n2_1*4)
    n3=(1.1929*atk+hp_dmg*4)*dmg+((0.2*atk)*cdmg_1/2)
    n3_dmg=n3*5
